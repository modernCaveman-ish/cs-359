...
function getUserLocation(){
    ...
    //             function() {
    //                 console.log('In');
    //                 console.log("Doing reverse location");
    //                 reverseLocation();
    //             });
    // }

    // reject('I dont have the coordinates');
    ...
    xhr.addEventListener("readystatechange", function () {
        if (this.readyState === this.DONE) {
            ...
            if(this.responseText != "{}") {
                ...
                document.getElementById('home_address').value = result.address.road; 
                console.log(result.address.country);
                console.log(result.address.city);
                document.getElementById('town').value = result.address.city;
                // console.log(xmlDoc);

...
public class CS359DB {
    ...
    private static final String UNAME = "ADD_YOUR_USERNAME"; // Share your repo to give you the credentials
    private static final String PASSWD = "ADD_YOUR_PASSWORD";  // Share your repo to give you the credentials
